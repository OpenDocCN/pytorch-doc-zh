...
![原始，调整大小，裁剪，裁剪和调整大小](../Images/6284bf3cc57087b145e22cb725ef3aad.png)
...
## 使用 StreamReader 对 NVDEC 进行基准测试[](#benchmark-nvdec-with-streamreader "跳转到此标题")
...
以下函数实现了管道3。调整大小由NVDEC执行，并且生成的张量放置在CUDA内存中。
