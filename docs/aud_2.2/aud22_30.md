...
#### 频率响应[](#frequency-response "跳转到此标题")
...
![不同截止频率的sinc低通滤波器的脉冲响应（频率相对于奈奎斯特频率）](../Images/1ab5671deb5c7117986c9ce609285f6d.png)
...
![脉冲响应，频率响应，频率响应（对数刻度）](../Images/a414b1b7403f4540005410fb0869d23f.png)
